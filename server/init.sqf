...
//Execute DAYZUK server side scripts
[] execVM "server\members.sqf"; //FOR REWARDS SYS
[] execVM "server\donators.sqf"; //FOR REWARDS SYS
[] execVM "server\afk.sqf"; //FOR REWARDS SYS
[] execVM "server\manageSystems.sqf"; //FOR SYS
