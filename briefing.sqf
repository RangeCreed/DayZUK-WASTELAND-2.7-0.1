player createDiarySubject ["space1", "######DAYZUK######"];
player createDiarySubject ["dayzuk", "DayZUK Information"];
...
player createDiarySubject ["space2", "######DAYZUK######"];
...
<br/>
    ...
    Developer - Pulse<br/>
	404 Server Host - Domuk<br/>
"
]
];

player createDiaryRecord["dayzuk",
[
"Bug and Cheat Reporting",
"
<br/>
	Found a bug? Please report it to Moses via PM at: www.DAYZUK.com<br/><br/>
	Suspect a player is hacking or exploiting? Please report it at: www.DAYZUK.com<br/><br/>
...
<br/>
	...
	Teamspeak IP: dayzuk.teamspeak.net<br/><br/>
	Please feel free to join and say hello! (Please speak English)
"
]
];
...
<br/>
    ...
    There are aggressive AI characters that spawn with most side missions and will protect the mission objectives with deadly force, be aware of them.<br/>
"
]
];
...
"
<br/>
	Administartors have access to all powers, they are equipped with tools that will allow them to deal with hackers and rule breakers. They also have the ability to initiate full server restarts, spawn vehicles and other things. If you have any issues please raise them with an administrator, the full list of administrator player names is shown below.<br/><br/>
	Moses<br/>
	DN<br/>

	<br/><br/>
	- TO SEE A LIST OF ONLINE STAFF USE !staff IN GLOBAL CHAT -<br/>
	- TO SEE A LIST OF BEC COMMANDS THAT CAN BE EXECUTED BY THIS GROUP VISIT dayzuk.info/bec -
"
]
];
...
"
<br/>
	Officers have access to the majority of powers, they are equipped with tools that will allow them to deal with hackers and rule breakers. They also have the ability to initiate full server restarts. If you have any issues please raise them with an officer, the full list of officer player names is shown below.<br/><br/>
...
"
<br/>
	Moderators have an array of powers at their disposal, they are equipped with tools that will allow them to deal with hackers and rule breakers. If you have any issues please raise them with a moderator, the full list of moderator player names is shown below.<br/><br/>
	Panda<br/>
	Kira<br/>
	Dynamite<br/>
	Waffles<br/>
